...
# OS VERSION: Ubuntu Server 13.10.
# ARCH: x32_64
...
# Ensure the installer is launched and can only be launched on Ubuntu 13.10
...
echo "Sorry, this installer only supports the installation of ZPanel on Ubuntu 13.10."
  exit 1;
fi
